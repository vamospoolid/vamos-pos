...
conn.on('ready', () => {
    console.log('✅ SSH Connected! Mem-patch WhatsApp Engine di VPS (PRODUCTION)...\n');
    
    const cmd = `
        echo "1. Mengubah webVersionCache di wa.service.ts (Production)..."
        ...
        echo "🎉 SELESAI! WhatsApp Engine di Production sudah di-patch."
    `;
